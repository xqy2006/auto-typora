...
import wget
wget.download("https://typoraio.cn/releases/dev_windows_64.json","./dev_windows_64.json")
s = json.load(open("./dev_windows_64.json","r",encoding="utf-8"))
